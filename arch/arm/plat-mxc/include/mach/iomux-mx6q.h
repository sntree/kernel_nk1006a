...
#define _MX6Q_PAD_GPIO_7__GPIO_1_8			\
		IOMUX_PAD(0x0614, 0x0244, 5, 0x0000, 0, 0) /* MIPI-LCD DISP_PWR_EN Signal */
...
#define  MX6Q_PAD_GPIO_7__GPIO_1_8		\
		(_MX6Q_PAD_GPIO_7__GPIO_1_8 | MUX_PAD_CTRL(NO_PAD_CTRL)) /* MIPI-LCD DISP_PWR_EN Signal */
