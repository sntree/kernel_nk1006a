...
{
	if (chip->p_idev) {
		 int proxim = chip->prx_inf.detected;
...
static struct device_attribute prox_attrs[] = {
	...
	__ATTR(prox_power_state, 0777, tsl2772_prox_enable_show, tsl2772_prox_enable),
};
...
static struct device_attribute als_attrs[] = {
	...
	__ATTR(als_power_state, 0777, tsl2772_als_enable_show, tsl2772_als_enable),
